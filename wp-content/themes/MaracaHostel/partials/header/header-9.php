...
<div id="header-main" class="header-main-section navbar">
	<div class="container">				
		...
		<div class="navbar-collapse zozo-topnavbar-collapse collapse contatos-top">
			...
			<ul class="nav navbar-nav navbar-right zozo-top-right">
				...
				<li class="header-details-box">
					...
					<div class="header-details-info header-address"><p class="endereco-top txt-top"><strong>Endereço:</strong> <?php echo force_balance_tags( $zozo_options['zozo_header_address'] ); ?></p></div>
				</li>
				<?php } ?>
				...
				<li class="header-details-box">
					...
					<div class="header-details-info header-contact-details">
						<p class="telefone-top txt-top"><strong>Contato:</strong> <?php echo force_balance_tags( $zozo_options['zozo_header_phone'] ); ?></p>
						<?php echo'<span class="email-header"><a href="mailto:'.force_balance_tags( $zozo_options['zozo_header_email'] ).'">'.force_balance_tags( $zozo_options['zozo_header_email'] ).'</a></span>'; ?>
					</div>
				</li>
				<?php } ?>
			</ul>
...
<div id="header-toggle" class="header-toggle-section header-position-<?php echo esc_attr( $header_toggle_position ); ?>">
	<div class="header-toggle-inner">
		...
		<?php } ?>
		<div class="menu-logo">
			<img src="http://agenciamegamix.com.br/maracahostel/wp-content/uploads/2017/10/logo-branco-maracahostel.png">
		</div>
